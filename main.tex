...
\subtitle{B\"urgerorienterte L\"osungen f\"ur das Stromnetz der Zukunft}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=12cm]{figures/Flukso.jpg}
...
OpenWRT. Die Daten werden von einem Lua-Script entgegengenommen,
aufbereitet und dann zur mySmartGrid-Webseite übertragen, wo sie
...
Stromverbrauchswerte frei. Der Vergleich mit anderen ist auch Gegenstand
von Diskussionen im Forum auf der Webseite.
...
Die momentan verfügbaren Ausleseköpfe sind jedoch entweder als
...
noch weitere Komponenten. Der Flukso ist momentan die preiswerteste
Variante.

Hinzu kommt, dass die Umsetzung der Kundenschnittstelle zunächst dem
Hersteller überlassen ist. Viele Hersteller setzen auf den
...
"`Chumby"' entschieden, vgl. Abbildung \todo{Bild}. Der Chumby basiert technisch
ebenso wie der Flukso auf einem WLAN-Router, hat allerdings einen Touchscreen und
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=12cm]{figures/raven-adapter.JPG}
